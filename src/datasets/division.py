...
class DivisionDataset(DatasetBase):
    """Dataset for division problems represented as step-by-step 2D blackboard grids."""

    def __init__(
        self, n_samples: int = 10000, max_dividend_digits: int = 3, max_divisor_digits: int = 1, seed: int = 42
    ):
        """Initialize division dataset.

        Args:
            n_samples: Number of addition problems to generate.
            max_dividend_digits: Maximum number of digits in the dividend.
            max_divisor_digits: Maximum number of digits in the divisor
            seed: Random seed for reproducibility.
        """
        self.n_samples = n_samples
        self.max_dividend_digits = max_dividend_digits
